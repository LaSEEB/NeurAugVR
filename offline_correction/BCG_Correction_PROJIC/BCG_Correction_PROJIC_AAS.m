...
% Usage:
%    >> [ PowerFreq, PowerFreq_bkg, eeg_bcg] = BCG_Correction_PROJIC(dataset, ...
...
% 
%  eeg_bcg (ADDED) [matrix] - Corrected signal 
% Author: Rodolfo Abreu, ISR/IST, Universade de Lisboa, 2015

function [ PowerFreq, PowerFreq_bkg, eeg_bcg] = BCG_Correction_PROJIC_AAS(dataset, ...
